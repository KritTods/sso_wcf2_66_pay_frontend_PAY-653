...
const PaymentBank: React.FC = () => {
  ...
  const handleConfirm = async (): Promise<void> => {
    ...
    if (resCreateApi.payload) {
      ...
      router.push(`${URL.taxDeliver.taxDeliverReadyToPayBankDetail.url}?id=${resCreateApi.payload.prepareToPayId}`);
  ...
  // function setIsOpenHistoryModal(arg0: boolean) {
  //   throw new Error('Function not implemented.');
  // 

  return (
    <div className=' flex flex-col justify-center gap-4 mx-4 mb-6'>
      <BaseForm name='paymentBank' onFinish={onFinish} initialValues={initFormData} extraForm={form}>
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex flex-row justify-center items-center gap-4'>
            <BaseButton
              ...
              type='cancel'
              label='ยกเลิก'
              onClick={() => router.push(URL.taxDeliver.taxDeliverReadyToPay.url)}
            />
