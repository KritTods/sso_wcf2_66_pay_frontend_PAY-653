...
export default function CardSearchTab({ dataTestId }: { dataTestId: string }): React.ReactElement {
  ...
  const { filter } = useSelector(cancelHospitalPaymentSelector);
  ...
  return (
    <div>
      <div className='flex p-6 bg-white shadow-sm rounded-xl'>
        <BaseForm name='hospital-payment-filter' onFinish={onFinish} initialValues={filter}>
            ...
            <div className='w-full'>
              <div className='flex flex-col gap-4'>
                <Row gutter={[16, 16]}>
                  ...
                  <Col {...searchColumn}>
                    <BaseItemInput
                      id={`${dataTestId}-payDate-input-text`}
