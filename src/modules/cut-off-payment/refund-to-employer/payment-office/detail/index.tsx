...
export default function PaymentOfficeDetail(): React.ReactElement {
  const dataTestId = 'pageCutOffPaymentRefundToEmployerDetail';
  ...
  useEffect(() => {
    ...
    const fetchData = async (): Promise<void> => {
      const { payload } = (await dispatch(getRefundToEmployerDetailService(id))) as PayloadAction<PageFormType>;
