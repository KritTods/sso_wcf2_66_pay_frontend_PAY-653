...
export default function PaymentOfficeForm(): React.ReactElement {
  const dataTestId = 'pageCutOffPaymentHospitalOfficeForm';
  ...
  const handleConfirm = (): void => {
    ...
    router.push(`${URL.cutOffPayment.cutOffHospitalPaymentOfficeDetail.url}?id=1`);
      ...
      <BaseForm name='paymentOfficeForm' initialValues={initialValuesForm} extraForm={form} onFinish={onSubmit}>
        <div className='flex flex-col gap-4 mx-4 mb-6'>
          ...
          <div className='w-full bg-white p-6 shadow-sm rounded-xl'>
            <TableListLayout
              key={'pageCutoffPaymentHospitalPayment'}
            ...
            <div className='w-full bg-white p-6 shadow-sm rounded-xl'>
              ...
              <div className='flex justify-center gap-4 mt-6'>
                {editCheque ? (
                  ...
                  <>
                    <BaseButton
                      id={`${dataTestId}-history-Cheques-button`}
                      icon={<ClockRotateRight />}
                      size='large'
