...
export default function PaymentMoneyDetail(): React.ReactElement {
  const dataTestId = 'pageCutOffPaymentOtherPaymentMoneyForm';
  ...
  const dataCardPreparePay = useMemo(() => {
    return {
      ...
      payType: pageForm.cardPreparePay?.payType || 'S',
      ...
      <div className='flex flex-col gap-4 mx-4 mb-6'>
        ...
        <div className='flex justify-center gap-4'>
          <BaseButton
            ...
            label='ยกเลิก'
            className='w-[240px]'
            onClick={() => router.push(URL.cutOffPayment.cutOffOtherPaymentMoney.url)}
          />
          {pageForm.isCheque && (
            <BaseButton
              size='large'
