  ...
  const columns = [
    {
      ...
      render: (treatMentDescription: string): React.ReactElement => {
        return (
          <div id={`${dataTestId}-treatMentDescription-label-title`} className='flex justify-start'>
    ...
    },
    {
      ...
      render: (startDate: string): React.ReactElement => {
        return (
          <div id={`${dataTestId}-startDate-label-title`} className='flex justify-center'>
            {formatDayThai(startDate)}
          </div>
        );
      },
    },
    {
      ...
      render: (endDate: string): React.ReactElement => {
        return (
          <div id={`${dataTestId}-endDate-label-title`} className='flex justify-center'>
            {formatDayThai(endDate)}
          </div>
        );
      },
    },
    ...
    },
    {
      ...
      render: (amount: number): React.ReactElement => {
        return (
          <div id={`${dataTestId}-amount-label-title`} className='flex justify-end'>
