...
export default function OfficeTab({ dataTestId }: BaseTabsProps): React.ReactElement {
  ...
  return (
    <BaseForm name='other-payment-form-X' onFinish={onFinish} extraForm={form} initialValues={initFormData}>
