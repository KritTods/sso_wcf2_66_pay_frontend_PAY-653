...
import { getBankDepositService } from '@/store-redux/slices/reserve/bankDeposit';

export default function CardSearchSsoBranchCode(): React.ReactElement {
  ...
  const handleSearch = (): void => {
    void dispatch(getBankDepositService());
  };
