...
import {
  ...
  getReceiptManualTaxDeliverFormService,
  PageFormType,
  setPageForm,
...
export default function PaymentDetailForm(): React.ReactElement {
  ...
  useEffect(() => {
      ...
      const fetchData = async (): Promise<void> => {
        const { payload } = (await dispatch(getReceiptManualTaxDeliverFormService(id))) as PayloadAction<PageFormType>;
  ...
  const handleConfirm = (): void => {
    ...
    router.push(`${URL.receiptManual.receiptManualTaxDeliverPaymentOfficeDetail.url}?id=1`);
  ...
  return (
    <>
      <BaseForm name='paymentDetailForm' initialValues={initialValuesForm} extraForm={form} onFinish={onSubmit}>
